...
static constexpr const auto& kPrefsMetricsBootCompleteTimeMs =
    "metrics-boot-complete-timestamp";
static constexpr const auto& kPrefsMetricsBootCompleteToMergeStartMs =
    "metrics-merge-start-duration";
